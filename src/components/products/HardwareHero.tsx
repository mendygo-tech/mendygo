...
const [isModalOpen, setIsModalOpen] = useState(false);
  ...
  return (
    <div>
      <div className="flex lg:grid flex-col-reverse  lg:grid-cols-[1fr_1fr] lg:h-120  gap-12 items-center lg:px-20 px-10">
        <div className="flex flex-col lg:text-left md:text-left text-center justify-center lg:items-start items-center gap-6">
          <div className="">
            <h2 className="">Mendygo Products</h2>
