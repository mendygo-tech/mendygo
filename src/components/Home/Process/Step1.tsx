...
const Step1 = () => {
    ...
    return (
        <div className="bg-white/10 dark:bg-black/20 backdrop-blur-xl border border-white/20 dark:border-white/10 text-gray-900 dark:text-white p-6 lg:w-[26rem] lg:h-80 rounded-2xl shadow-2xl shadow-black/30 dark:shadow-black/30 flex flex-col">
