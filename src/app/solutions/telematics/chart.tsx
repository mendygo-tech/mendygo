  ...
  return (
    ...
    >
      <div className="rounded-3xl border border-gray-300 dark:border-white/25 bg-white dark:bg-zinc-900 shadow-xl p-4 sm:p-6">
        ...
        <p className="mt-3 text-[10px] sm:text-[11px] text-gray-600 dark:text-gray-400">
          Telemetry updates every ~1.2s. Data is simulated for demonstration purposes.
        </p>
      </div>
    </section>
  );
...
function Metric({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-xl bg-gray-100 dark:bg-white/10 border border-gray-300 dark:border-white/25 px-3 sm:px-4 py-3">
